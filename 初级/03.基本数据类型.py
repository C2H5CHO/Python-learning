...
# scipy库
# 1.Optimize (优化)--提供了多种优化算法，包括最小化(最大化)函数、曲线拟合等
...
# 2.Integrate (积分和微分方程求解)--提供了多种数值积分方法以及 ODE 求解器
...
# 3.Linalg (线性代数)--扩展了 NumPy 的线性代数能力，提供了更多高级功能
...
# 4.Signal (信号处理)--提供了一系列工具用于信号处理，如滤波、卷积等
...
# 5.Stats (统计分布和函数)--提供了广泛的统计分布模型和统计测试
